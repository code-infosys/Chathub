<%@ Page Title="" Language="C#" MasterPageFile="~/Mstar.Master" AutoEventWireup="true" CodeBehind="profileviewer.aspx.cs" Inherits="Chathub.roompages.profileviewer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="objUsersget" runat="server" SelectMethod="GetProfileVisitors" TypeName="Chathub.Methodsall">
        <SelectParameters>
            <asp:SessionParameter Type="Int32" SessionField="user_id" Name="userid" />
        </SelectParameters>
